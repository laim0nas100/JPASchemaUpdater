 ...
 * @since 4.0.3
 */
public abstract class SpringScriptUtils {
    ...
    private static final Log logger = LogFactory.getLog(SpringScriptUtils.class);
     ...
     * @throws ScriptException if an error occurred while splitting the SQL
     * script
     ...
     *
     * @param script the SQL script
     * @param separator text separating each statement &mdash; typically a ';'
     ...
     * @param separator text separating each statement &mdash; typically a ';'
     * or newline character; never {@code null}
     * @param commentPrefix the prefix that identifies SQL line comments &mdash;
     * typically "--"; never {@code null} or empty
     * @param blockCommentStartDelimiter the <em>start</em> block comment
     * delimiter; never {@code null} or empty
    ...
    /**
     * Read a script from the given resource, using "{@code --}" as the comment
     * prefix and "{@code ;}" as the statement separator, and build a String
     ...
     * @throws ScriptException if an error occurred while executing the SQL
     * script
     ...
     * @param connection the JDBC connection to use to execute the script;
     * already configured and ready to use
     * @param resource the resource (potentially associated with a specific
     * encoding) to load the SQL script from
     * @throws ScriptException if an error occurred while executing the SQL
     * script
     * @see #executeSqlScript(Connection, EncodedResource, boolean, boolean,
     * String, String, String, String)
     ...
     * @param commentPrefix the prefix that identifies single-line comments in
     * the SQL script &mdash; typically "--"
